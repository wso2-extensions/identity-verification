...
<%@ page import="org.wso2.carbon.extension.identity.verification.ui.client.IdentityProviderMgtServiceClient" %>
...
<%@ page import="org.wso2.carbon.extension.identity.verification.ui.util.IdPManagementUIUtil"%>
<%@ page import="org.apache.commons.lang.StringUtils" %>
<jsp:include page="../dialog/display_messages.jsp"/>

<%!
    private static final String TRUSTED_CALLBACK_EDIT = "idp-mgt-edit.jsp";
    private static final String TRUSTED_CALLBACK_LIST = "idvp-mgt-list.jsp";
%>
<%
